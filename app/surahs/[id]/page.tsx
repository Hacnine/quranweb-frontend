...
export default async function SurahPage({ params }: PageProps) {
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-6">
      {/* Surah Header */}
      <div className="mb-6 rounded-xl bg-gradient-to-br from-emerald-600 to-emerald-700 p-6 text-center text-white shadow-lg">
      ...
      {surahNumber !== 1 && surahNumber !== 9 && (
        <p
          className="mb-6 text-center font-arabic text-2xl text-gray-700"
          dir="rtl"
        >
