...
export default function IconSidebar() {
  ...
  return (
    <>
      ...
      <aside className="hidden laptop:flex fixed top-0 left-0 z-40 h-screen w-[60px] flex-col items-center bg-qm-sidebar border-r border-qm-border">
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-6 px-0 py-4 w-full">
