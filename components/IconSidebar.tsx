...
export default function IconSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-full w-14 flex-col items-center border-r border-qm-border bg-qm-sidebar py-3">
      {/* Logo */}
      <Link href="/surahs/1" className="mb-4 flex items-center justify-center">
        <Image
          src="/Qur'an.svg"
          alt="QuranWeb"
          width={32}
      ...
      <nav className="flex flex-1 flex-col items-center gap-1 pt-2">
        ...
        <button
          onClick={() => dispatch(toggleSurahSidebar())}
          className="flex h-10 w-10 items-center justify-center rounded-lg text-qm-muted transition-colors hover:bg-white/10 hover:text-qm-green"
          title="Surah List"
        >
          <svg
      ...
      <button
        onClick={() => dispatch(toggleSidebar())}
        className="mb-2 flex h-10 w-10 items-center justify-center rounded-lg text-qm-muted transition-colors hover:bg-white/10 hover:text-qm-green"
        title="Font Settings"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
